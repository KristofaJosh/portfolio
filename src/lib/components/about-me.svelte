...
>
	<div class="text-center">
		...
		<p class="mt-4 text-lg text-pretty text-slate-300 sm:text-xl">Software Engineer</p>

		<p
			class="mx-auto mt-6 max-w-2xl text-base leading-relaxed text-pretty text-slate-400 sm:text-lg"
		>
			Building performant, intuitive, and user‑centered digital experiences with modern web
			technology.
		</p>
